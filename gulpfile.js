...
// Add testing
// Continuous Integration with Codeship / Travis CI? 
...
var handlebarsData = require('./' + appConfig.src + 'handlebars/data.json');
var handlebarsHelpers = require('./' + appConfig.src + '/handlebars/helpers');
...
gulp.task('watch', function() {
  ...
  gulp.watch(appConfig.src + 'handlebars/*', ['handlebars', reload]);
